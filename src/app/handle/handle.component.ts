...
export class HandleComponent implements OnInit {
  ...
  private userService: UserService, private vehicleService: VehicleService,private router: Router ) { }
  ...
  aggiorna(object: any){
    ...
    if(this.tipo === 2){
      ...
      const user = new User(object.values['id'], object.values['nome'],  object.values['cognome'],  object.values['email'],  object.values['password'],object.values['tipo']);
